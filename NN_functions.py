...
if __name__ == '__main__':
    ...
    opt_dW1 = np.load('dW1.npy')
    opt_db1 = np.load('db1.npy')
    opt_dW2 = np.load('dW2.npy')
    opt_db2 = np.load('db2.npy')
    opt_dW3 = np.load('dW3.npy')
    opt_db3 = np.load('db3.npy')
    opt_dE_dnet3 = np.load('dE_dnet3.npy')
    opt_dE_dout2 = np.load('dE_dout2.npy')
    opt_dE_dnet2 = np.load('dE_dnet2.npy')
    opt_dE_dnet1 = np.load('dE_dnet1.npy')
    print("*"*100)
